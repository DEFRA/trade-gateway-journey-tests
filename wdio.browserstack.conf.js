...
export const config = {
  ...
  baseUrl: `https://trade-gateway-journey-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `trade-gateway-journey-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `trade-gateway-journey-tests-${process.env.ENVIRONMENT}`
        },
